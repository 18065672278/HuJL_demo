...
Page({
  ...
  showProductDetail: function(e) {
    console.log(e);
    wx.navigateTo({
      url: '../idCardInfoEdit/index?id=' + e.currentTarget.dataset.index,
    })
  },
  //选中
  selectList(e) {
  ...
  productList: function(favorList) {
    ...
    for (let i = 0, length = favorList.length; i < length; i++) {
      ...
      listA.secondRowR = cui.isEmpty(favorList[i].birthday) ? "" : favorList[i].birthday;
