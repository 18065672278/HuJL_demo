...
Page({
  ...
  addBtn: function(e) {
    wx.navigateTo({
      url: '../../car/truck/index?select=true&&fleetId=' + this.data.fleetId + '&&type=fleet',
    })
  },
  //编辑
  showProductDetail: function(e) {
    console.log(e);
    wx.navigateTo({
      url: '../../car/truckEdit/index?id=' + e.currentTarget.dataset.index,
    })
  },
  //左滑开始
  ...
  delProductItem(e) {
    ...
    WXEXT.showModal('', "是否确定删除", true, '确定删除', '取消', function(data) {
      if (data.confirm) {
        ...
        WXEXT.request(API_SERVER + API_api.fleetCarsaveUnBandInfo, {
  ...
  query: function(queryNext, searchNext) {
    ...
    WXEXT.request(API_SERVER + API_api.fleetCarqueryBindCar, s, '', me.callback)
  },
  //查询回调
