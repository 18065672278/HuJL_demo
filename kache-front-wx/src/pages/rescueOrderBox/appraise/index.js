// src/pages/rescueOrderBox/appraise/index.js
...
Page({
  ...
  starTap: function(e) {
    ...
    for (var i = 0; i < len; i++) {
      if (i <= index) { // 小于等于index的是满心
        tempUserStars[i] = "../../../assets/images/icons/star1.png";
        that.setData({
          wjxScore: i + 1,
        })
      } else { // 其他是空心
        tempUserStars[i] = "../../../assets/images/icons/star0.png"
      }
    }
    // 重新赋值就可以显示了
    that.setData({
  ...
  handleBtn() {
    let starLevel = this.data.wjxScore;
    ...
    WXEXT.request(API_SERVER + API_api.orderappraise, data, '', this.callback)
  },
